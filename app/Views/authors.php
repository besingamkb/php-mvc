...
<!--        <p>--><?php //= htmlspecialchars($author['name']) ?><!--</p>-->
<!--    --><?php //endforeach;
//} ?>
...
<div class="relative overflow-x-auto">
    ...
    <form class="max-w-md ">
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search for books, authors..." />
    ...
    <div id="page-info" class="px-6 py-4 text-center text-gray-600 dark:text-gray-400"></div>
